...
;
const cartItems = ref(JSON.parse(localStorage.getItem('cartItem')));
...
const favoriteSneakers = computed(()=>items.value.filter(item=>item.isFavorite))
...
<template>
  ...
  <div class="bg-white w-4/5 m-auto rounded-xl shadow-xl mt-10">
    ...
    <div class="p-10">
      ...
      <CardList :items="favoriteSneakers" />
    </div>
